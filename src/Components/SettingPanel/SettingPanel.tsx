...
<input type="text" value={selectedNode.data.label} className="p-2 border border-1 border-[#D1D5DB] mt-2 rounded-md w-[90%] hover:shadow-sm transition  focus:outline-none focus:ring-1 focus:ring-[#6040E0] focus:border-[#6040E0]"/>
...
<textarea value={selectedNode.data.description}  className="h-[95px] p-2 border border-1 border-[#D1D5DB] mt-2 rounded-md w-[90%] hover:shadow-sm transition focus:outline-none focus:ring-1 focus:ring-[#6040E0] focus:border-[#6040E0]" />
...
<p> Selected Description : { selectedNode.data.description }</p> */}
